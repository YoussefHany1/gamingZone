...
import { getYoutubeThumbnailUrl, getYoutubeEmbedUrl } from "../hooks/useEvent";
  ...
  return (
    <>
      <div
        ...
        className="group relative shrink-0 w-64 h-36 rounded-2xl overflow-hidden glass-panel border border-white/10 cursor-pointer shadow-lg hover:shadow-live-red/20 transition-all duration-300 hover:-translate-y-1"
      >
        <Image
        ...
        />
        <div className="absolute inset-0 bg-linear-to-t from-dark-bg/90 via-dark-bg/20 to-transparent"></div>
        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm">
          <div className="relative w-full max-w-5xl aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl border border-white/10">
            ...
            <iframe
              width="100%"
              height="100%"
              src={getYoutubeEmbedUrl(video.video_id)}
              title={video.name}
              frameBorder="0"
