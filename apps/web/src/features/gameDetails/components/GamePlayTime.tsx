...
export default function GamePlayTime({ playTime, t, lang }: GamePlayTimeProps) {
  ...
  if (
    !playTime ||
    (playTime.main === null &&
      playTime.mainExtra === null &&
      playTime.completionist === null)
  )
    return null;
      ...
      <div className="space-y-3 text-xs">
        ...
        {playTime.mainExtra && (
          <div className="flex justify-between items-center bg-white/5 p-3 rounded-2xl">
            ...
            <span className="text-light-blue font-black text-sm">
              {playTime.mainExtra} {t("games.details.howLongToBeat.hours")}
            </span>
          </div>
        )}
        ...
        {playTime.completionist && (
          <div className="flex justify-between items-center bg-white/5 p-3 rounded-2xl">
            ...
            <span className="text-light-blue font-black text-sm">
              {playTime.completionist} {t("games.details.howLongToBeat.hours")}
            </span>
          </div>
        )}
      </div>
