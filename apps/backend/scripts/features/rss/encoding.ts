...
function fixArabHardwareEncoding(buffer: Buffer): string {
    ...
    { type: 'Win-1256', fn: () => iconv.decode(buffer, 'windows-1256') },
    {
      ...
      fn: () => {
        const latinStr = utf8Str.replace(
          CP1252_REGEX,
          (char) => CP1252_MAP[char as keyof typeof CP1252_MAP],
        );
  ...
  console.log(`      ✅ Winner: ${bestResult.type} (Score: ${bestResult.score})`);
  return bestResult.text;
}

export { fixArabHardwareEncoding };
