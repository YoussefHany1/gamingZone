          ...
          return (
            ...
            >
              <div className="relative w-full h-[200px] z-0 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-[40%] bg-linear-to-t from-[#0b1426]/90 to-transparent z-10 pointer-events-none" />

                {/* Store Icon Badge */}
                <div className="absolute bottom-2 left-2 bg-primary-bg/90 rounded-full p-1.5 border border-secondary-blue z-20">
                  <Image
                    src={storeIcon}
                    alt={fg.store || "store"}
                    width={20}
              ...
              <div className="flex-1 p-3 flex flex-col justify-between">
                ...
                {fg.type === "current" && (
                  <Link
                    ...
                    className="flex items-center justify-center gap-1.5 py-2 mt-2 bg-linear-to-br from-[#9CB4DD] to-secondary-blue rounded-xl shadow-md transition-all active:scale-95 hover:opacity-90"
                  >
