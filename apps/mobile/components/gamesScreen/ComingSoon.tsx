  ...
  return (
    ...
    >
      ...
      <Image
        source={
          item.cover
            ? { uri: `https://images.igdb.com/igdb/image/upload/t_screenshot_big/${item.cover.image_id}.webp` } : require("../../assets/image-not-found.webp")
        }
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.coverContainer}>
          <Image
            source={
              item.cover
                ? { uri: `https://images.igdb.com/igdb/image/upload/t_cover_big/${item.cover.image_id}.webp` } : require("../../assets/image-not-found.webp")
            }
            style={styles.cover}
            resizeMode="cover"
          />
