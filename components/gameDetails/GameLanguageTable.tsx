...
// Column order matches the table: Audio | Subtitles | Interface
const COLUMN_KEYS = ["Audio", "Subtitles", "Interface"] as const;
      ...
      <View style={styles.tableHeader}>
        ...
        {COLUMN_KEYS.map((key) => (
          <View key={key} style={styles.iconHeaderCell}>
            ...
            <Text style={styles.headerCellLabel}>{t(COLUMN_I18N_KEYS[key])}</Text>
          </View>
        ))}
      </View>
